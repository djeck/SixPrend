...
/**
 * \fn void identifySrv(char *name)
 * \brief s'identifier sur le serveur
 * note: seulement une fois dans une salle de jeu
 * \arg name chaine de caractére correspondant à son nom
 */

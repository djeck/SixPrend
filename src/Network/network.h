...
typedef struct
{
    int32_t table[4][5]; /*!< les cartes sur la table, 4 ranges de 10 cartes maximum, vaut 0 si derniere carte de la rangée */
    char users[10][BUF_SIZE]; /*!< nom de chaques joueurs */
    int32_t turn[10]; /*!< choix de chaque joueurs */
    int32_t place[10]; /*!< où chaque joueur place sa carte */
